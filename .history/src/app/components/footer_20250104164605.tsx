...
<footer className="bg-gray-900 text-white py-8">
  ...
  <div className="mt-8 border-t border-gray-700 pt-4 text-center text-gray-500">
    ...
    <div className="flex justify-center space-x-4 mt-4">
      <a href="https://web.facebook.com/asadullah.shafique" className="hover:text-white transition">
        <i className="fab fa-facebook-f" />
      </a>
      <a href="#" className="hover:text-white transition">
        <i className="fab fa-twitter" />
      </a>
      <a href="https://www.instagram.com/shafiqueasadullah/" className="hover:text-white transition">
        <i className="fab fa-instagram" />
      </a>
      <a href="https://www.linkedin.com/in/asadullah-shafique-a00679325/" className="hover:text-white transition">
